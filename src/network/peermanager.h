...
public:
    ...
    QList<PeerInfo> hiddenPeers() const;
    QList<GroupInfo> groups() const;

    void setDisplayName(const QString &displayName);
    void refreshDiscovery();
    PeerInfo addManualPeer(const QString &displayName, const QHostAddress &address, quint16 port);
    ...
    bool restorePeer(const QString &peerId);
...
private:
    ...
    void loadKnownPeers(QSettings &settings);
    void saveKnownPeers() const;
